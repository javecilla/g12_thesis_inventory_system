...
<html>
    ...
    <!-- c for open source library: https://ekoopmans.github.io/html2pdf.js/ -->
    <script src="../../vendor/plugins/html2pdf/html2pdf.bundle.min.js"></script>
   <!--  <script src="https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.10.1/html2pdf.bundle.min.js" integrity="sha512-GsLlZN/3F2ErC5ifS5QtgpiJtWd43JWSuIgh7mbzZ8zBps+dvLusV+eNQATqgA/HdeKFVgA5v3S/cIrLF7QnIg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script> -->
	</head>
<body onload="generatePDF()"> <!--onload="generatePDF()"-->
	<center>
		<div class="card table-responsive" id="pdfcontent" style="width:100%;"> 
      <center>
      ...
      <table id="tblPDF" class="table table-responsive " style="width:100%">
        <thead>
          <tr>
	...
	<script type="text/javascript">
      ...
      //hide the button back when pdf download
      ...
      const opt = { 
        margin:       0.1,
        filename:     `Inventory_Report_${formattedDate}.pdf`,
