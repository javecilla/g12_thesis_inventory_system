...
<html>
	<head>
	  ...
	  <!-- <script src="../../vendor/plugins/export2excel/xlsx.min.js"></script> -->
  	<script src="../../vendor/plugins/export2excel/xlsx.full.min.js"></script>
	</head>
<body onload="generateExcel()"> <!--onload="generateExcel()"-->
	<center>
      ...
      <table id="tblEquipment" class="table table-responsive " style="width:100%">
        <thead>
          <tr>
	...
	<script type="text/javascript">
      ...
      const formattedDate = currentDate.toLocaleDateString();
			...
			const tableData = document.getElementById('tblEquipment');

			let fp = XLSX.utils.table_to_book(tableData, {
				sheet: 'InventoryEquipment'
			});
			XLSX.write(fp, {
				bookType: 'xlsx',
				type: 'base64'
			});
			XLSX.writeFile(fp, `Inventory_Report_${formattedDate}.xlsx`); 
		}
